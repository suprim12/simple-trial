          ...
          <section className='hero'>
            ...
            <div className='hero__right'>
              <div className='hero__bg_image'>
                ...
                <img src='/hero_bg.png' className='d-img' alt='hero' />
              </div>
          ...
          <section className='insight'>
            <div className='insight__content'>
              <div className='insight__content_left'>
                <img src='/hero_to.png' className='d-img' alt='hero_to' />
              </div>
          ...
          <section className='team'>
            <div className='team__content'>
              <div className='team__content_left'>
                <img className='d-img' src='team.png' alt='team' />
              </div>
              <div className='team__content_right'>
                <h1>
                  A team of dedicated people committed to advancing and
                  protecting the interests of our clients.
                </h1>

                <p>
                  Quisque malesuada placerat nisl. Vestibulum facilisis, purus
                  nec pulvinar iaculis, ligula mi congue nunc, vitae euismod
                  ligula urna in dolor nam adipiscing es leor palas.
                </p>
              ...
              <div className='footer__right'>
                <div className='footer__right_items'>
                  <div className='footer__item'>
                    ...
                    <p>
                      Level 10, 81 Flinders Street Adelaide SA 5000 Tel +61 8
                      8210 2222 dmaw@dmawlawyers.com.au
                    </p>
                  </div>
                  <div className='footer__item'>
